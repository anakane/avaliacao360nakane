...
///Cria a avaliação modelo dos usuários da equipe 
     ...
     */
    @PostMapping("/avaliacao-modelos/submit")
    @Timed
    public ResponseEntity<AvaliacaoControle> submitAvaliacaoModelo(@Valid @RequestBody Long avaliacaoModeloId) throws URISyntaxException {
        log.debug("Service to get : {}", avaliacaoModeloId);
        if (avaliacaoModeloId == null) {
        ...
        AvaliacaoControle result = this.avaliacaoModeloService.submit(avaliacaoModeloId);
