...
public class Pergunta implements Serializable {
    ...
    public Pergunta avaliacaoControle(AvaliacaoControle avaliacaoControle) {
    ...
    public void setPerguntaLayout(PerguntaLayout perguntaLayout) {
    	this.assunto = perguntaLayout.getAssunto();
    	this.texto = perguntaLayout.getTexto();
    }
