(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope, $translate) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('avaliacao360NakaneApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                ...
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('avaliacao360NakaneApp.' + fieldError.objectName + '.' + convertedField);
