(function() {
    ...
    AvaliacaoControleDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'AvaliacaoControle', 'User', 'Pergunta'];

    function AvaliacaoControleDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, AvaliacaoControle, User, Pergunta) {
        var vm = this;
