(function() {
    ...
    AvaliacaoControleDetailController.$inject = ['$scope', '$rootScope', '$stateParams', 'previousState', 'entity', 'AvaliacaoControle', 'User', 'Pergunta'];

    function AvaliacaoControleDetailController($scope, $rootScope, $stateParams, previousState, entity, AvaliacaoControle, User, Pergunta) {
        var vm = this;
